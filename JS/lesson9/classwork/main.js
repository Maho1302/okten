...
for (const course of coursesArray) {
    ...
    let mouthAndHourElement = document.createElement('div');
    mouthAndHourElement.style.display = 'flex';
    ...
    hourDurationElement.style.width = '70%'
    ...
    mouthAndHourElement.append(monthDurationElement, hourDurationElement);
    courseElement.appendChild(titleElement);
    courseElement.appendChild(mouthAndHourElement);
